...
<div id="btnsup"  >
    ...
    <button class="btn btn-success">2025</button>
    <button class="btn btn-warning">2026</button>
</div>
...
<div class="container dashboard">
    <div class="events">
        <div class="text-right mb-3">
            <!-- Print Button -->
            <a href='new_event.php?event_id={$event['event_id']}' class='btn btn-success btn-sm'>Add Event</a>
                            ...
                            while ($event = $result->fetch_assoc()) {
                                ...
                                echo "<tr data-event-id='{$event['event_id']}'>
                                        ...
                                        <td class='actions-column'>
                                            <a href='add_event.php?event_id={$event['event_id']}' class='btn btn-success btn-sm'>Edit</a>
                                            <a href='delete_event.php?event_id={$event['event_id']}' class='btn btn-danger btn-sm' onclick='return confirmDelete()'>Delete</a>
                                        </td>
                                    </tr>";
                            }
                        } else {
